...
module.exports = function (sails) {
  ...
  return {
    ...
    initialize: function (next) {
        ...
        var enabled = sails.config.i18n.debug.enabled, 
            namespaces = sails.config.i18n.debug.namespaces;
        if(enabled !== false)
  				return ' ' + (namespaces ||
  					[
  						'core',
		...
		domain.create()
				...
				.run(function() {
					...
					sails.gengo = core.clone();
					sails.__ = core.clone().__;
					sails.__l = core.clone().__l;
				});
      return next();
    }
  };
